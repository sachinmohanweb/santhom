...
@section('title', 'Import Bible Verses')
...
@section('breadcrumb-items')
    <li class="breadcrumb-item">Import Bible Verses</li>
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Please Note</h5>
                        <span>When importing data for Bible Verses via Excel, manual validation is essential. It's mandatory to thoroughly review the details for accuracy, ensuring error-free data for future use.
                        </span>
                    </div>
                        ...
                        <form class="needs-validation" novalidate="" action="{{route('admin.bible.verse.Import.store')}}" method="Post" id="import-form_Bible">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-primary" onclick="window.location='{{ route('admin.bibleverse.list') }}'">Cancel</a> 
                                </div> 
                            </div> 
                        </form>
                    </div>
