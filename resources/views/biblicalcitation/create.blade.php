...
@section('content')
  <div class="container-fluid">
    <div class="edit-profile">
      ...
      <form class="needs-validation" novalidate="" action="{{route('admin.biblical.citation.store')}}" 
          method="Post" enctype="multipart/form-data">
          @csrf
        <div class="col-xl-11">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title mb-0">Biblical Citation Details</h4>
                  ...
                  <div class="media-body">
                    <div class="row">
                      ...
                      <div class="col-md-4 pd_left_zero">
                        ...
                        <input class="form-control" placeholder="Note" name="note1" >
                      </div>
                       <div class="col-md-4 pd_left_zero">

                        <label class="form-label">Other details</label>
                        <input class="form-control" placeholder="Other details" name="note2">
                      </div>
                    </div><br>
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="reference" name="reference" rows="5" required></textarea ><br>
